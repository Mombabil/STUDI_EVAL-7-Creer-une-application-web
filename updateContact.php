...
$contact = $contactManager->get($_GET['id']);
...
try {
    if ($_POST) {
        ...
        $contactManager->update($newContact, $idContact);
    ...
    ?>
            ...
            <main>
                <form method="post">
                    ...
                    <input type="text" name="name" id="name" value="<?= $contact->getName() ?>" placeholder="Le nom du contact" class="form-control">
                    <label for="firstname">Prénom</label>
                    <input type="text" name="firstname" id="firstname" value="<?= $contact->getfirstname() ?>" placeholder="Le prénom du contact" class="form-control">
                    <label for="dateOfBirth">Date de naissance</label>
                    <input type="date" name="dateOfBirth" id="dateOfBirth" value="<?= $contact->getDateOfBirth() ?>" placeholder="La date de naissance du contact" class="form-control">
                    <label for="code">Code</label>
                    <input type="text" name="code" id="code" value="<?= $contact->getCodename() ?>" placeholder="Le nom de code du contact" class="form-control">
                    ...
                    <input type="submit" value="Modifier la cible" class="btn btn-success submit">
                </form>
            </main>
