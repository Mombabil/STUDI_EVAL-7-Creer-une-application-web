...
$cible = $ciblesManager->get($_GET['id']);
$idCible = $cible->getId();
$error = null;
...
try {
    if ($_POST) {
        ...
        $ciblesManager->update($newCible, $idCible);
    ...
    ?>
            ...
            <main>
                <form method="post">
                    ...
                    <input type="text" name="name" id="name" value="<?= $cible->getName() ?>" placeholder="Le nom de la cible" class="form-control">
                    <label for="firstname">Prénom</label>
                    <input type="text" name="firstname" id="firstname" value="<?= $cible->getfirstname() ?>" placeholder="Le prénom de la cible" class="form-control">
                    <label for="dateOfBirth">Date de naissance</label>
                    <input type="date" name="dateOfBirth" id="dateOfBirth" value="<?= $cible->getDateOfBirth() ?>" placeholder="La date de naissance de la cible" class="form-control">
                    <label for="code">Code</label>
                    <input type="text" name="code" id="code" value="<?= $cible->getCodename() ?>" placeholder="Le nom de code de la cible" class="form-control">
