...
$contactDisplay = $contactsManager->getAllByDesc();
        ...
        <div class="missionsDisplay">
            <table class="table table-striped table-bordered table-dark">
                ...
                <tbody>
                    ...
                    <?php
                    foreach ($contactDisplay as $contact) : ?>
                        <tr>
                            <td>
                                <?php
                                if ($_SESSION['login'] == $admin->getEmail()) {
                                    if ($cryptedPwd == $admin->getPassword()) {
                                ?>
                                        <a href="./updateContact.php?id=<?= $contact->getId() ?>">Modifier</a>
                                <?php
                                    }
                                }
                                ?>
