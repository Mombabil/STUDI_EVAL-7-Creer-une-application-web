...
$agent = $agentsManager->get($_GET['id']);
$idAgent = $agent->getId();
$error = null;
...
try {
    if ($_POST) {
        ...
        $agentsManager->update($newAgent, $idAgent);
    ...
    ?>
            ...
            <main>
                <form method="post">
                    ...
                    <input type="text" name="name" id="name" value="<?= $agent->getName() ?>" placeholder="Le nom de l'agent" class="form-control">
                    <label for="firstname">Prénom</label>
                    <input type="text" name="firstname" id="firstname" value="<?= $agent->getfirstname() ?>" placeholder="Le prénom de l'agent" class="form-control">
                    <label for="dateOfBirth">Date de naissance</label>
                    <input type="date" name="dateOfBirth" id="dateOfBirth" value="<?= $agent->getDateOfBirth() ?>" placeholder="La date de naissance de l'agent" class="form-control">
                    <label for="code">Code</label>
                    <input type="number" name="code" id="code" value="<?= $agent->getCode() ?>" placeholder="Le numéro d'identification de l'agent" class="form-control">
